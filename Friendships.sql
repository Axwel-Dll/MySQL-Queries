...
#2
SELECT u.first_name, u.last_name, u2.first_name as friend_first_name, u2.last_name as friend_last_name, COUNT(f.friend_id) as friendships_total
FROM users u
LEFT JOIN friendships f
ON f.user_id=u.id
INNER JOIN users as u2 
...
#3
SELECT user_id, CONCAT(u.first_name," ",u.last_name) as name, MAX(total_friend) as number_friends
...
#6
SELECT f.user_id, u.first_name, u.last_name, u2.first_name as friend_first_name, u2.last_name as friend_last_name, friend_id
FROM users u
LEFT JOIN friendships f
ON f.user_id=u.id
INNER JOIN users as u2 
